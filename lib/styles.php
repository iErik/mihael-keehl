...
function mihael_color_luminance($hexcolor, $percent)
{
...
function mihael_custom_styles( $custom ) {
  ...
  if ( !empty($body_bg) && ($body_bg != '#F9F9F9') ) {
    $custom .= '.posts-navigation .nav-previous, .posts-navigation .nav-next { background-color:' . mihael_color_luminance($body_bg, -0.055) . ' !important; border-color:' . mihael_color_luminance($body_bg, -0.10) . ' !important;}' . "\n";
    $custom .= '.page-links a { background-color: ' . mihael_color_luminance($body_bg, -0.055) . ' !important; border-color: ' . mihael_color_luminance($body_bg, -0.10) . ' !important;}' . "\n";
    $custom .= 'blockquote { border-color: ' . mihael_color_luminance($body_bg, -0.225) . ' !important; background-color: ' . mihael_color_luminance($body_bg, -0.055) . ' !important;}' . "\n";
    $custom .= 'blockquote::before { color: ' . mihael_color_luminance($body_bg, -0.3755) . ' !important;}' . "\n";
    $custom .= 'blockquote cite { color: ' . mihael_color_luminance($body_bg, -0.3755) . ' !important;}' . "\n";
    $custom .= '.post-feed .hentry { border-color:' . mihael_color_luminance($body_bg, -0.103) . ' !important;}' . "\n";
    $custom .= '.post-feed .hentry .post-category { background-color:' . mihael_color_luminance($body_bg, -0.06) . ' !important;}' . "\n";
    $custom .= '.comments-area .comment-list .comment { border-color:' . mihael_color_luminance($body_bg, -0.06) . ' !important;}' . "\n";
    $custom .= '.comments-area .comment-list .comment .reply { background-color:' . mihael_color_luminance($body_bg, -0.08) . ' !important;}' . "\n";
  }
  ...
  if ( !empty($body_text_color) && ($body_text_color != '#454545') ) {
    ...
    $custom .= '.single-post .post.hentry .post-footer, .page-template-default .page.hentry .post-footer { color: ' . mihael_color_luminance($body_text_color, -0.3855) . ' !important; }' . "\n";
    $custom .= '.comments-heading::after, .comments-heading::before { background-color:' . mihael_hex2rgba($body_text_color, 0.54) .  ' !important; }' . "\n";
    $custom .= '.comment-body .comment-author .says, .comment-body .comment-metadata a { color:' . mihael_color_luminance($body_text_color, 0.05) . ' !important; }' . "\n";
  ...
  if ( !empty($header_text_color) && ($header_text_color != '#FFF') ) {
    ...
    $custom .= '.header .panel-control.is-active .search-field { color:' . mihael_hex2rgba($header_text_color, 0.9) . ' !important; border-color: ' . mihael_hex2rgba($header_text_color, 0.5) . ' !important;}' . "\n";
  ...
  if ( !empty($post_content_color) && ($post_content_color != '#525252') ) {
    ...
    $custom .= '.page-template-page-sans-serif .post-content { color:' . mihael_color_luminance($post_content_color, 0.09) . ' !important; }' . "\n";
  }
